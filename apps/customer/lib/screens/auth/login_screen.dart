...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _checkPendingBooking() async {
    ...
    if (mounted && draft != null) {
      setState(() => _hasPendingBooking = true);
    }
  }
  ...
  Future<void> _submit() async {
    ...
    // This device will never show the guest option again.
    await AppModeService.setAccount();
    if (!mounted) return;

    // Resume a guest's mid-booking if there is one.
    ...
    // Normal post-login routing — straight to home if we already have a
    // location saved (a returning user, or a guest who set one).
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Booking-resume banner — only shown when a guest hit the
                  // register wall on the payment step and came here instead.
