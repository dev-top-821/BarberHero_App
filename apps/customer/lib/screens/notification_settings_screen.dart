...
/// Minimal settings screen — surfaces the current FCM permission state
/// and lets the user re-request it if they previously dismissed the
/// prompt. Channel-level (per-category) toggles would need server state
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                granted
                                    ? "You'll hear about booking updates and messages."
                                    : "You won't get booking reminders or chat alerts.",
                                style: const TextStyle(
                                  fontSize: 13,
                  ...
                  if (!granted) ...[
                    ...
                    const Text(
                      ...
                      '→ Apps → BarberHero → Notifications to turn them on.',
                      style: TextStyle(
                        fontSize: 13,
                        color: AppColors.textSecondary,
                        height: 1.4,
                  ...
                  const _Row(
                    ...
                    subtitle: 'When a barber accepts, arrives, or completes.',
                  ),
                  const _Row(
                    icon: Icons.chat_bubble_outline_rounded,
                    title: 'New messages',
                    subtitle: 'Chat from your barber.',
                  ),
                  const _Row(
                    icon: Icons.receipt_long_rounded,
                    title: 'Refund outcomes',
                    subtitle: 'If a report you filed is resolved.',
                  ),
                ],
              ),
      ),
